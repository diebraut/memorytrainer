...
public:
    ...
    Q_INVOKABLE bool createMixPackage(QString packageName,int cntExercise,QVariantList fromPackageList, bool override,bool withReverseEntries,QJSValue  jsReturnInfoVal);
    Q_INVOKABLE bool removePackage(QString packageName,bool isCustomPackage,QJSValue  jsReturnInfoVal);
